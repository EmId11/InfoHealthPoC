...
export const dimensionDescriptions: DimensionDescription[] = [
  ...
  },
  {
    ...
    summary: 'Measures whether critical fields are populated and contain meaningful content before work begins.',
    whatWeMeasure: `We check field coverage (are descriptions, acceptance criteria, and estimates populated?), data integrity (is the content meaningful or just placeholders?), and timing (was information available before commitment?).`,
    whyItMatters: `Data gaps and low-quality data lead to ambiguity, rework, and unreliable metrics. When developers start work without real acceptance criteria, they build the wrong thing. When estimates are defaults, planning is guesswork.`,
    whatYouCanDo: `Identify which fields are consistently empty or filled with placeholder content. Add refinement checklists and definition of ready criteria to ensure work is genuinely prepared before sprint planning.`,
    clusterId: 'dataQuality',
  },
  {
    key: 'dataFreshness',
