...
export const MOCK_JIRA_FIELDS_BY_ISSUE_TYPE: JiraFieldForIssueType[] = [
  // Standard fields
  { id: 'assignee', name: 'Assignee', type: 'user', isCustom: false, applicableIssueTypes: ['story', 'bug', 'task', 'epic', 'subtask', 'risk', 'assumption', 'feature', 'spike', 'dependency', 'impediment', 'initiative'] },
  { id: 'reporter', name: 'Reporter', type: 'user', isCustom: false, applicableIssueTypes: ['story', 'bug', 'task', 'epic', 'subtask', 'risk', 'assumption', 'feature', 'spike', 'dependency', 'impediment', 'initiative'] },
  { id: 'priority', name: 'Priority', type: 'select', isCustom: false, applicableIssueTypes: ['story', 'bug', 'task', 'epic', 'subtask', 'risk', 'assumption', 'feature', 'spike', 'dependency', 'impediment', 'initiative'] },
  { id: 'duedate', name: 'Due Date', type: 'date', isCustom: false, applicableIssueTypes: ['story', 'bug', 'task', 'epic', 'risk', 'assumption', 'feature', 'spike', 'dependency', 'impediment', 'initiative'] },
  { id: 'labels', name: 'Labels', type: 'multi-select', isCustom: false, applicableIssueTypes: ['story', 'bug', 'task', 'epic', 'subtask', 'risk', 'assumption', 'feature', 'spike', 'dependency', 'impediment', 'initiative'] },
  { id: 'components', name: 'Components', type: 'multi-select', isCustom: false, applicableIssueTypes: ['story', 'bug', 'task', 'epic', 'risk', 'assumption', 'feature', 'spike', 'dependency', 'impediment', 'initiative'] },
  { id: 'fixVersions', name: 'Fix Version', type: 'select', isCustom: false, applicableIssueTypes: ['story', 'bug', 'task'] },
  { id: 'description', name: 'Description', type: 'text', isCustom: false, applicableIssueTypes: ['story', 'bug', 'task', 'epic', 'subtask', 'risk', 'assumption', 'feature', 'spike', 'dependency', 'impediment', 'initiative'] },
  // Custom fields
  ...
  // New custom fields for extended issue types
  { id: 'customfield_10030', name: 'Severity', type: 'select', isCustom: true, applicableIssueTypes: ['bug', 'impediment'] },
  { id: 'customfield_10031', name: 'Root Cause', type: 'select', isCustom: true, applicableIssueTypes: ['bug'] },
  { id: 'customfield_10032', name: 'Customer Impact', type: 'select', isCustom: true, applicableIssueTypes: ['bug', 'story', 'feature'] },
  { id: 'customfield_10033', name: 'Risk Category', type: 'select', isCustom: true, applicableIssueTypes: ['risk'] },
  { id: 'customfield_10034', name: 'Probability', type: 'select', isCustom: true, applicableIssueTypes: ['risk'] },
  { id: 'customfield_10035', name: 'Impact', type: 'select', isCustom: true, applicableIssueTypes: ['risk', 'assumption'] },
  { id: 'customfield_10036', name: 'Risk Score', type: 'number', isCustom: true, applicableIssueTypes: ['risk'] },
  { id: 'customfield_10037', name: 'Mitigation Strategy', type: 'text', isCustom: true, applicableIssueTypes: ['risk'] },
  { id: 'customfield_10038', name: 'Risk Owner', type: 'user', isCustom: true, applicableIssueTypes: ['risk'] },
  { id: 'customfield_10039', name: 'Confidence Level', type: 'select', isCustom: true, applicableIssueTypes: ['assumption'] },
  { id: 'customfield_10040', name: 'Validation Status', type: 'select', isCustom: true, applicableIssueTypes: ['assumption'] },
  { id: 'customfield_10041', name: 'Validation Date', type: 'date', isCustom: true, applicableIssueTypes: ['assumption'] },
  { id: 'customfield_10042', name: 'Impact if Wrong', type: 'text', isCustom: true, applicableIssueTypes: ['assumption'] },
  { id: 'customfield_10043', name: 'Benefit Hypothesis', type: 'text', isCustom: true, applicableIssueTypes: ['feature'] },
  { id: 'customfield_10044', name: 'WSJF Score', type: 'number', isCustom: true, applicableIssueTypes: ['feature', 'epic'] },
  { id: 'customfield_10045', name: 'Target PI', type: 'select', isCustom: true, applicableIssueTypes: ['feature', 'epic', 'risk', 'dependency'] },
  { id: 'customfield_10046', name: 'Feature Size', type: 'select', isCustom: true, applicableIssueTypes: ['feature'] },
  { id: 'customfield_10047', name: 'Research Question', type: 'text', isCustom: true, applicableIssueTypes: ['spike'] },
  { id: 'customfield_10048', name: 'Time-box', type: 'number', isCustom: true, applicableIssueTypes: ['spike'] },
  { id: 'customfield_10049', name: 'Findings', type: 'text', isCustom: true, applicableIssueTypes: ['spike'] },
  { id: 'customfield_10050', name: 'Decision', type: 'select', isCustom: true, applicableIssueTypes: ['spike'] },
  { id: 'customfield_10051', name: 'Dependency Type', type: 'select', isCustom: true, applicableIssueTypes: ['dependency'] },
  { id: 'customfield_10052', name: 'Provider Team', type: 'select', isCustom: true, applicableIssueTypes: ['dependency'] },
  { id: 'customfield_10053', name: 'Consumer Team', type: 'select', isCustom: true, applicableIssueTypes: ['dependency'] },
  { id: 'customfield_10054', name: 'Needed By Date', type: 'date', isCustom: true, applicableIssueTypes: ['dependency'] },
  { id: 'customfield_10055', name: 'Impact Area', type: 'select', isCustom: true, applicableIssueTypes: ['impediment'] },
  { id: 'customfield_10056', name: 'Escalation Level', type: 'select', isCustom: true, applicableIssueTypes: ['impediment'] },
  { id: 'customfield_10057', name: 'Resolution Plan', type: 'text', isCustom: true, applicableIssueTypes: ['impediment'] },
  { id: 'customfield_10058', name: 'Strategic Theme', type: 'select', isCustom: true, applicableIssueTypes: ['initiative'] },
  { id: 'customfield_10059', name: 'Business Outcome', type: 'text', isCustom: true, applicableIssueTypes: ['initiative'] },
  { id: 'customfield_10060', name: 'Target Quarter', type: 'select', isCustom: true, applicableIssueTypes: ['initiative'] },
  { id: 'customfield_10061', name: 'Expected Revenue Impact', type: 'number', isCustom: true, applicableIssueTypes: ['initiative'] },
  { id: 'customfield_10062', name: 'Affected Teams', type: 'multi-select', isCustom: true, applicableIssueTypes: ['impediment', 'dependency'] },
];
