...
export const MOCK_MY_ASSESSMENTS: SavedAssessment[] = [
  {
    ...
    teamIds: TEAMS_SOLID.map(t => t.id),
    teamNames: TEAMS_SOLID.map(t => t.name),
    wizardStateSnapshot: {
      ...initialWizardState,
      step1: {
  ...
  },
  {
    ...
    teamIds: TEAMS_HIGH.map(t => t.id),
    teamNames: TEAMS_HIGH.map(t => t.name),
    wizardStateSnapshot: {
      ...initialWizardState,
      step1: {
        ...initialWizardState.step1,
  ...
  },
  {
    ...
    teamIds: TEAMS_IMPROVING.map(t => t.id),
    teamNames: TEAMS_IMPROVING.map(t => t.name),
    wizardStateSnapshot: {
      ...initialWizardState,
      step1: {
        ...initialWizardState.step1,
  ...
  },
  {
    ...
    teamIds: TEAMS_DECLINING.map(t => t.id),
    teamNames: TEAMS_DECLINING.map(t => t.name),
    wizardStateSnapshot: {
      ...initialWizardState,
      step1: {
        ...initialWizardState.step1,
...
export const MOCK_SHARED_WITH_ME: SavedAssessment[] = [
  {
    ...
    teamIds: TEAMS_AVERAGE.map(t => t.id),
    teamNames: TEAMS_AVERAGE.map(t => t.name),
    wizardStateSnapshot: {
      ...initialWizardState,
      step1: {
        ...initialWizardState.step1,
  ...
  },
  {
    ...
    teamIds: TEAMS_MIXED.map(t => t.id),
    teamNames: TEAMS_MIXED.map(t => t.name),
    wizardStateSnapshot: {
      ...initialWizardState,
      step1: {
        ...initialWizardState.step1,
