...
const prioritisationIndicators: IndicatorResult[] = [
  {
    id: 'timeToStability',
  ...
  },
  {
    ...
    name: 'Priority rank vs. delivery order correlation',
    description: 'Weak correlation between the priority rank of a work item before the sprint and the likelihood of it being completed in the same sprint. 40% of teams show weak correlation (similar to ours).',
    value: 0.25,
    displayValue: '0.25',
    unit: 'correlation',
    benchmarkValue: 0.65,
    benchmarkDisplayValue: '0.65',
    benchmarkComparison: 'bottom 30% of the comparison group',
    benchmarkPercentile: 30,
    trend: 'stable',
    higherIsBetter: true,
    whyItMatters: 'Low correlation means high-priority items aren\'t being delivered first, risking delays on critical work.',
    trendData: [
      { period: '2024-03', value: 0.28, benchmarkValue: 0.65 },
      { period: '2024-04', value: 0.27, benchmarkValue: 0.65 },
      { period: '2024-05', value: 0.26, benchmarkValue: 0.65 },
      { period: '2024-06', value: 0.27, benchmarkValue: 0.65 },
      { period: '2024-07', value: 0.25, benchmarkValue: 0.65 },
      { period: '2024-08', value: 0.26, benchmarkValue: 0.65 },
      { period: '2024-09', value: 0.25, benchmarkValue: 0.65 },
      { period: '2024-10', value: 0.26, benchmarkValue: 0.65 },
      { period: '2024-11', value: 0.25, benchmarkValue: 0.65 },
    ],
    distribution: { min: 0.10, max: 0.85, otherTeamValues: [0.18, 0.28, 0.38, 0.48, 0.58, 0.65, 0.72, 0.78, 0.82] },
  },
  {
    id: 'priorityProgressCorrelation',
    name: 'Priority rank vs. in-progress timing correlation',
    description: 'Weak correlation between priority rank before commitment and likelihood of moving to in-progress ahead of others. 30% of teams show weak correlation.',
    value: 0.22,
    displayValue: '0.22',
    unit: 'correlation',
    benchmarkValue: 0.60,
    benchmarkDisplayValue: '0.60',
    benchmarkComparison: 'bottom 30% of the comparison group',
    benchmarkPercentile: 30,
    trend: 'stable',
    higherIsBetter: true,
    whyItMatters: 'When priority doesn\'t influence start order, the team may be cherry-picking easier tasks over important ones.',
    trendData: [
      { period: '2024-03', value: 0.24, benchmarkValue: 0.60 },
      { period: '2024-04', value: 0.23, benchmarkValue: 0.60 },
      { period: '2024-05', value: 0.24, benchmarkValue: 0.60 },
      { period: '2024-06', value: 0.22, benchmarkValue: 0.60 },
      { period: '2024-07', value: 0.23, benchmarkValue: 0.60 },
      { period: '2024-08', value: 0.22, benchmarkValue: 0.60 },
      { period: '2024-09', value: 0.23, benchmarkValue: 0.60 },
      { period: '2024-10', value: 0.22, benchmarkValue: 0.60 },
      { period: '2024-11', value: 0.22, benchmarkValue: 0.60 },
    ],
    distribution: { min: 0.08, max: 0.82, otherTeamValues: [0.15, 0.25, 0.35, 0.45, 0.55, 0.62, 0.68, 0.75, 0.78] },
  },
  {
    id: 'sameSprintCompletion',
    name: 'Priority rank vs. same-sprint completion',
    description: 'Weak correlation between priority rank before commitment and likelihood of completing in the same sprint. 40% of teams show weak correlation.',
    value: 0.28,
    displayValue: '0.28',
    unit: 'correlation',
    benchmarkValue: 0.70,
    benchmarkDisplayValue: '0.70',
    benchmarkComparison: 'bottom 40% of the comparison group',
    benchmarkPercentile: 40,
    trend: 'improving',
    higherIsBetter: true,
    whyItMatters: 'Low correlation suggests priority rankings aren\'t guiding which items get completed within sprints.',
    trendData: [
      { period: '2024-03', value: 0.14, benchmarkValue: 0.70 },
      { period: '2024-04', value: 0.16, benchmarkValue: 0.70 },
      { period: '2024-05', value: 0.18, benchmarkValue: 0.70 },
      { period: '2024-06', value: 0.20, benchmarkValue: 0.70 },
      { period: '2024-07', value: 0.22, benchmarkValue: 0.70 },
      { period: '2024-08', value: 0.24, benchmarkValue: 0.70 },
      { period: '2024-09', value: 0.25, benchmarkValue: 0.70 },
      { period: '2024-10', value: 0.27, benchmarkValue: 0.70 },
      { period: '2024-11', value: 0.28, benchmarkValue: 0.70 },
    ],
    distribution: { min: 0.12, max: 0.88, otherTeamValues: [0.20, 0.32, 0.42, 0.52, 0.62, 0.70, 0.76, 0.82, 0.85] },
  },
];

const prioritisationCategory: IndicatorCategory = {
  id: 'prioritisation',
  name: 'Effectiveness of prioritisation',
  shortName: 'Priority Effectiveness',
  description: 'Measures whether priority labels actually predict delivery order.',
  rationale: 'If <strong>priority doesn\'t predict delivery</strong>, what\'s the point of setting it? These indicators examine whether your prioritisation system actually works—whether high-priority items get worked on first and completed first. Weak correlation between stated priority and actual delivery sequence suggests priorities are either <strong>set arbitrarily</strong>, <strong>set too early</strong>, or simply <strong>ignored</strong> when work begins.',
  statusColor: '#FFFAE6',
  status: 'moderate',
  issuesCount: 3,
  indicators: prioritisationIndicators,
};
...
export const mockDimension2Result: DimensionResult = {
  ...
  categories: [availabilityCategory, readinessCategory, prioritisationCategory],
