...
): IndicatorResult['trendData'] {
  const periods = [
    '2024-03', '2024-04', '2024-05', '2024-06', '2024-07',
    '2024-08', '2024-09', '2024-10', '2024-11',
  ];
  const n = periods.length;
  // Use a deterministic seed based on baseValue to avoid re-render flicker
  const seed = Math.round(baseValue * 1000);
  const pseudoRand = (i: number) => {
    const x = Math.sin(seed + i * 9301 + 49297) * 0.5 + 0.5;
    return (x - 0.5) * 0.08; // ±4% noise
  };

  return periods.map((period, i) => {
    let v: number;
    if (trend === 'improving') {
      // Values decrease over time (getting better = less failures)
      const startOffset = 0.15;
      const slope = -startOffset / (n - 1);
      v = baseValue + startOffset + slope * i + pseudoRand(i);
    } else if (trend === 'declining') {
      // Values increase over time (getting worse)
      const startOffset = -0.12;
      const slope = -startOffset / (n - 1);
      v = baseValue + startOffset + slope * i + pseudoRand(i);
    } else {
      // Stable: small noise around base
      v = baseValue + pseudoRand(i);
    }
    return {
      period,
      value: Math.min(1, Math.max(0, v)),
      healthScore: Math.floor(30 + ((seed + i * 7) % 40)),
      benchmarkValue: 0.75,
    };
  });
}
...
const availabilityIndicators: IndicatorResult[] = [
  {
    ...
    higherIsBetter: false,
    trendData: [
      { period: '2024-03', value: 65, benchmarkValue: 55 },
      { period: '2024-04', value: 68, benchmarkValue: 55 },
      { period: '2024-05', value: 70, benchmarkValue: 55 },
      { period: '2024-06', value: 72, benchmarkValue: 55 },
      { period: '2024-07', value: 74, benchmarkValue: 55 },
      { period: '2024-08', value: 77, benchmarkValue: 55 },
      { period: '2024-09', value: 79, benchmarkValue: 55 },
      { period: '2024-10', value: 80, benchmarkValue: 55 },
      { period: '2024-11', value: 82, benchmarkValue: 55 },
    ],
  ...
  },
  {
    ...
    benchmarkComparison: 'top 45% of the comparison group',
    benchmarkPercentile: 55,
    trend: 'improving',
    higherIsBetter: false,
    trendData: [
      { period: '2024-03', value: 68, benchmarkValue: 50 },
      { period: '2024-04', value: 63, benchmarkValue: 50 },
      { period: '2024-05', value: 60, benchmarkValue: 50 },
      { period: '2024-06', value: 56, benchmarkValue: 50 },
      { period: '2024-07', value: 52, benchmarkValue: 50 },
      { period: '2024-08', value: 49, benchmarkValue: 50 },
      { period: '2024-09', value: 46, benchmarkValue: 50 },
      { period: '2024-10', value: 44, benchmarkValue: 50 },
      { period: '2024-11', value: 42, benchmarkValue: 50 },
    ],
  ...
  },
  {
    ...
    higherIsBetter: false,
    trendData: [
      { period: '2024-03', value: 40, benchmarkValue: 20 },
      { period: '2024-04', value: 44, benchmarkValue: 20 },
      { period: '2024-05', value: 52, benchmarkValue: 20 },
      { period: '2024-06', value: 58, benchmarkValue: 20 },
      { period: '2024-07', value: 60, benchmarkValue: 20 },
      { period: '2024-08', value: 56, benchmarkValue: 20 },
      { period: '2024-09', value: 52, benchmarkValue: 20 },
      { period: '2024-10', value: 50, benchmarkValue: 20 },
      { period: '2024-11', value: 48, benchmarkValue: 20 },
    ],
  ...
  },
  {
    ...
    higherIsBetter: false,
    trendData: [
      { period: '2024-03', value: 70, benchmarkValue: 25 },
      { period: '2024-04', value: 73, benchmarkValue: 25 },
      { period: '2024-05', value: 71, benchmarkValue: 25 },
      { period: '2024-06', value: 74, benchmarkValue: 25 },
      { period: '2024-07', value: 72, benchmarkValue: 25 },
      { period: '2024-08', value: 71, benchmarkValue: 25 },
      { period: '2024-09', value: 73, benchmarkValue: 25 },
      { period: '2024-10', value: 72, benchmarkValue: 25 },
      { period: '2024-11', value: 72, benchmarkValue: 25 },
    ],
  ...
  },
  {
    ...
    benchmarkValue: 5,
    benchmarkDisplayValue: '5%',
    benchmarkComparison: 'top 40% of the comparison group',
    benchmarkPercentile: 60,
    trend: 'improving',
    higherIsBetter: false,
    trendData: [
      { period: '2024-03', value: 25, benchmarkValue: 5 },
      { period: '2024-04', value: 22, benchmarkValue: 5 },
      { period: '2024-05', value: 19, benchmarkValue: 5 },
      { period: '2024-06', value: 17, benchmarkValue: 5 },
  ...
  },
  {
    ...
    higherIsBetter: false,
    trendData: [
      { period: '2024-03', value: 45, benchmarkValue: 30 },
      { period: '2024-04', value: 48, benchmarkValue: 30 },
      { period: '2024-05', value: 52, benchmarkValue: 30 },
      { period: '2024-06', value: 55, benchmarkValue: 30 },
      { period: '2024-07', value: 58, benchmarkValue: 30 },
      { period: '2024-08', value: 62, benchmarkValue: 30 },
      { period: '2024-09', value: 64, benchmarkValue: 30 },
      { period: '2024-10', value: 66, benchmarkValue: 30 },
  ...
  },
  {
    ...
    benchmarkComparison: 'top 30% of the comparison group',
    benchmarkPercentile: 70,
    trend: 'improving',
    higherIsBetter: false,
    trendData: [
      { period: '2024-03', value: 78, benchmarkValue: 65 },
      { period: '2024-04', value: 80, benchmarkValue: 65 },
      { period: '2024-05', value: 76, benchmarkValue: 65 },
      { period: '2024-06', value: 70, benchmarkValue: 65 },
      { period: '2024-07', value: 65, benchmarkValue: 65 },
      { period: '2024-08', value: 62, benchmarkValue: 65 },
      { period: '2024-09', value: 58, benchmarkValue: 65 },
      { period: '2024-10', value: 56, benchmarkValue: 65 },
      { period: '2024-11', value: 55, benchmarkValue: 65 },
    ],
  ...
  },
  {
    ...
    benchmarkValue: 55,
    benchmarkDisplayValue: '55%',
    benchmarkComparison: 'top 25% of the comparison group',
    benchmarkPercentile: 75,
    trend: 'improving',
    higherIsBetter: false,
    trendData: [
      { period: '2024-03', value: 62, benchmarkValue: 55 },
      { period: '2024-04', value: 58, benchmarkValue: 55 },
      { period: '2024-05', value: 53, benchmarkValue: 55 },
      { period: '2024-06', value: 48, benchmarkValue: 55 },
      { period: '2024-07', value: 44, benchmarkValue: 55 },
      { period: '2024-08', value: 40, benchmarkValue: 55 },
      { period: '2024-09', value: 36, benchmarkValue: 55 },
      { period: '2024-10', value: 33, benchmarkValue: 55 },
      { period: '2024-11', value: 30, benchmarkValue: 55 },
    ],
...
function mkFinding(
  ...
  return {
    ...
    trendData: generateMockTrendData(value, trend),
