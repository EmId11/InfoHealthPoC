...
interface Dimension3ModalProps {
  dimension: DimensionResult;
  reportOptions: Step6Data;
  onClose: () => void;
}

const Dimension3Modal: React.FC<Dimension3ModalProps> = ({
  dimension,
  reportOptions,
  onClose,
}) => {
      ...
      case 'estimationCoverage':
        return (
          <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
            <path d="M2 3a1 1 0 011-1h10a1 1 0 011 1v10a1 1 0 01-1 1H3a1 1 0 01-1-1V3zm2 1v2h8V4H4zm0 4v2h5V8H4zm0 4v1h3v-1H4z"/>
          </svg>
        );
          ...
          <div style={styles.headerLeft}>
            ...
            <div>
              <h2 style={styles.title}>
                {selectedCategory ? selectedCategory.shortName : 'How We Assess Estimation Coverage'}
              </h2>
          ...
          {!selectedCategory ? (
            ...
            <>
                  ...
                  <div style={styles.volumeBanner}>
                    ...
                    <div style={styles.volumeBannerMain}>
                      ...
                      <div style={styles.volumeBannerSeverity}>
                        <span style={styles.volumeBannerSeverityLabel}>Estimation Coverage</span>
                        <div style={{
              ...
              <p style={styles.introText}>
                We assess estimation coverage by analyzing <strong>what proportion of your work is estimated</strong>.
                This includes checking which issue types are estimated by policy, what percentage of estimable items
                actually have estimates, and whether epics have sufficient coverage of estimated children.
              </p>
              ...
              <div style={styles.categoriesGrid}>
                {dimension.categories.map((category, index) => {
                  ...
                  // Story-telling description for coverage
                  const storyDescription = category.id === 'estimationCoverage'
                    ? 'We check what proportion of your work is estimated and identify gaps in coverage.'
                    : 'Analyzing the estimation coverage for this category.';
              ...
              <div style={styles.scoringNote}>
                <strong>How we calculate coverage:</strong> We compare your team's estimation coverage against
                similar teams. Indicators in the <strong>bottom 25th percentile</strong> are flagged as concerning.
                The overall coverage level is based on your composite percentile: High Risk (≤25th), Moderate (26-75th),
...
export default Dimension3Modal;
