...
interface Dimension2ModalProps {
  dimension: DimensionResult;
  reportOptions: Step6Data;
  onClose: () => void;
}

const Dimension2Modal: React.FC<Dimension2ModalProps> = ({
  dimension,
  reportOptions,
  onClose,
}) => {
        ...
        <div style={styles.content}>
          {!selectedCategory ? (
            ...
            <>
                  ...
                  <div style={styles.volumeBanner}>
                    ...
                    <div style={styles.volumeBannerMain}>
                      ...
                      <div style={styles.volumeBannerSeverity}>
                        <span style={styles.volumeBannerSeverityLabel}>Health Level</span>
                        <div style={{
              ...
              {/* Methodology Note - reframed */}
              <div style={styles.scoringNote}>
                <strong>How we calculate health:</strong> We compare your team's indicators against
                similar teams. Indicators in the <strong>bottom 25th percentile</strong> are flagged as concerning.
                The overall health level is based on your composite percentile: Low Health (≤25th), Moderate (26-75th),
                or High Health (&gt;75th percentile).
                <button
...
export default Dimension2Modal;
