...
interface Dimension6ModalProps {
  dimension: DimensionResult;
  reportOptions: Step6Data;
  onClose: () => void;
}

const Dimension6Modal: React.FC<Dimension6ModalProps> = ({
  dimension,
  reportOptions,
  onClose,
}) => {
      ...
      <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
        <div style={styles.header}>
          <div style={styles.headerLeft}>
            <div>
              <h2 style={styles.title}>How We Assess Data Freshness</h2>
        ...
        <div style={styles.content}>
          <div style={styles.volumeBanner}>
            <div style={styles.volumeBannerMain}>
              ...
              <div style={styles.volumeBannerSeverity}>
                <span style={styles.volumeBannerSeverityLabel}>Data Freshness</span>
                <div style={{
          ...
          <div style={styles.scoringNote}>
            <strong>How we calculate freshness:</strong> We compare your team's data freshness indicators against
...
export default Dimension6Modal;
