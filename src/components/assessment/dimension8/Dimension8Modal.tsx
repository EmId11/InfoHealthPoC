...
interface Dimension8ModalProps {
  dimension: DimensionResult;
  reportOptions: Step6Data;
  onClose: () => void;
}

const Dimension8Modal: React.FC<Dimension8ModalProps> = ({
  dimension,
  reportOptions,
  onClose,
}) => {
      ...
      <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
        <div style={styles.header}>
          <div style={styles.headerLeft}>
            <div>
              <h2 style={styles.title}>How We Assess Work Hierarchy Linkage</h2>
        ...
        <div style={styles.content}>
          <div style={styles.volumeBanner}>
            <div style={styles.volumeBannerMain}>
              ...
              <div style={styles.volumeBannerSeverity}>
                <span style={styles.volumeBannerSeverityLabel}>Work Hierarchy Linkage</span>
                <div style={{
            ...
            <div style={styles.volumeBannerConfidence}>
              ...
              <span style={styles.confidenceNote}>
                Based on {totalIndicators} indicator{totalIndicators > 1 ? 's' : ''} compared against similar teams in your organization
              </span>
            </div>
          </div>
          ...
          <div style={styles.scoringNote}>
            <strong>How we calculate linkage:</strong> We analyze the percentage of work items that are properly
            linked to epics and initiatives. Indicators in the <strong>bottom 25th percentile</strong> are flagged as concerning.
            <button
...
export default Dimension8Modal;
