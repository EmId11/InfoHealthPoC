...
import { DimensionMethodologyContent } from '../../../constants/methodologyContent';

interface GenericMethodologyExplainerProps {
  onClose: () => void;
  content: DimensionMethodologyContent;
}
...
const GenericMethodologyExplainer: React.FC<GenericMethodologyExplainerProps> = ({ onClose, content }) => {
    ...
    <div style={styles.overlay} onClick={onClose}>
      <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={styles.header}>
          <div>
            <h2 style={styles.title}>{content.modalTitle}</h2>
            <p style={styles.subtitle}>{content.modalSubtitle}</p>
          </div>
        ...
        <div style={styles.content}>
            ...
            <div style={styles.section}>
              ...
              <div style={styles.heroCard}>
                ...
                <div style={styles.heroContent}>
                  ...
                  <p style={styles.heroText} dangerouslySetInnerHTML={{ __html: content.overviewText }} />
                </div>
              </div>
              ...
              <div style={styles.frameworkSteps}>
                ...
                <div style={styles.frameworkStep}>
                  ...
                  <div style={styles.frameworkStepContent}>
                    ...
                    <div style={styles.frameworkStepDesc}>{content.totalIndicatorCount} key indicators extracted from your Jira data</div>
                  </div>
                </div>
                <div style={styles.frameworkStep}>
              ...
              <div style={styles.principlesGrid}>
                ...
                <div style={styles.principleCard}>
                  ...
                  <p style={styles.principleText}>
                    We analyze <strong>{content.totalIndicatorCount} distinct indicators</strong> across {content.categories.length} {content.categories.length === 1 ? 'category' : 'categories'}.
          ...
          {activeSection === 2 && (
            <div style={styles.section}>
              {/* Hero with large indicator count */}
              <div style={styles.heroCard}>
                <div style={styles.heroLargeNumber}>{content.totalIndicatorCount}</div>
                <div style={styles.heroContent}>
                  <h3 style={styles.heroTitle}>Leading Indicators</h3>
                  <p style={styles.heroText}>
                    Organized into {content.categories.length} {content.categories.length === 1 ? 'category' : 'categories'}, each targeting a different aspect of {content.dimensionName.toLowerCase()}.
                ...
                {content.categories.map((cat, i) => (
                  <div key={i} style={{...styles.categoryShowcard, borderLeftColor: cat.color}}>
                    <div style={styles.categoryShowcardHeader}>
                      ...
                      <span style={{...styles.categoryShowcardBadge, backgroundColor: cat.bgColor, color: cat.color}}>
                        {cat.indicatorCount} indicator{cat.indicatorCount !== 1 ? 's' : ''}
                      </span>
                    </div>
                    <p style={styles.categoryShowcardInsight}>{cat.description}</p>
...
export default GenericMethodologyExplainer;
