...
interface Dimension9ModalProps {
  dimension: DimensionResult;
  reportOptions: Step6Data;
  onClose: () => void;
}

const Dimension9Modal: React.FC<Dimension9ModalProps> = ({
  dimension,
  reportOptions,
  onClose,
}) => {
      ...
      <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
        <div style={styles.header}>
          <div style={styles.headerLeft}>
            <div>
              <h2 style={styles.title}>How We Assess Sprint Hygiene</h2>
        ...
        <div style={styles.content}>
          <div style={styles.volumeBanner}>
            <div style={styles.volumeBannerMain}>
              ...
              <div style={styles.volumeBannerSeverity}>
                <span style={styles.volumeBannerSeverityLabel}>Sprint Hygiene</span>
                <div style={{
          ...
          <div style={styles.scoringNote}>
            <strong>How we calculate sprint hygiene:</strong> We compare your team's sprint practices against
...
export default Dimension9Modal;
