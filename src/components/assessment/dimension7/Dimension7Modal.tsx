...
interface Dimension7ModalProps {
  dimension: DimensionResult;
  reportOptions: Step6Data;
  onClose: () => void;
}

const Dimension7Modal: React.FC<Dimension7ModalProps> = ({
  dimension,
  reportOptions,
  onClose,
}) => {
      ...
      <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
        <div style={styles.header}>
          <div style={styles.headerLeft}>
            <div>
              <h2 style={styles.title}>How We Assess Blocker Management</h2>
        ...
        <div style={styles.content}>
          <div style={styles.volumeBanner}>
            <div style={styles.volumeBannerMain}>
              ...
              <div style={styles.volumeBannerSeverity}>
                <span style={styles.volumeBannerSeverityLabel}>Blocker Management</span>
                <div style={{
          ...
          <div style={styles.scoringNote}>
            <strong>How we calculate blocker management:</strong> We compare your team's blocker capture and resolution
            patterns against similar teams. Indicators in the <strong>bottom 25th percentile</strong> are flagged as concerning.
            <button
...
export default Dimension7Modal;
